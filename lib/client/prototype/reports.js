 ...
 */
proto.detailedReport = function (opts, callback) {
    if (!this._validateOptions('report-detailed', opts, callback)) {
        return;
    }
 ...
 * @param {function} callback Accepts arguments: (err, report)
 */
proto.summaryReport = function (opts, callback) {
    if (!this._validateOptions('report-weekly', opts, callback)) {
        return;
    }
 ...
 * @param {function} callback Accepts arguments: (err, report)
 */
proto.weeklyReport = function (opts, callback) {
    if (!this._validateOptions('report-weekly', opts, callback)) {
        return;
    }
