 ...
 * @public
 */
proto.addTimeEntriesTags = function (teIds, tags, callback) {
 ...
 */
proto.createTimeEntry = function (data, callback) {
    data.created_with = TogglClient.USER_AGENT;

    if (!this._validateOptions('time-entry-create', data, callback)) {
        return;
    }
    ...
    this._apiRequest('/api/v8/time_entries', req, utils.wrapDataCallback(callback));
};
 ...
 */
proto.deleteTimeEntry = function (teId, callback) {
    var req = {
        method: 'DELETE'
    };

    this._apiRequest('/api/v8/time_entries/' + teId, req, callback);
};
 ...
 * @param {function} callback Accepts arguments: (err, timeEntry)
 */
proto.getTimeEntryData = function (teId, callback) {
    this._apiRequest('/api/v8/time_entries/' + teId, {}, utils.wrapDataCallback(callback));
};
 ...
 */
proto.getTimeEntries = function (startDate, endDate, callback) {
    ...
    if (!this._validateOptions('time-entry-get-timerange', qs, callback)) {
        return;
    }
    ...
    this._apiRequest('/api/v8/time_entries', req, callback);
};
 ...
 * @param {function} callback Accepts arguments: (err, timeEntry)
 */
proto.getCurrentTimeEntry = function (callback) {
    this._apiRequest('/api/v8/time_entries/current', {}, utils.wrapDataCallback(callback));
};
 ...
 * @public
 */
proto.removeTimeEntriesTags = function (teIds, tags, callback) {
 ...
 * @param {function} callback Accepts arguments: (err, timeEntry)
 */
proto.startTimeEntry = function (data, callback) {
    data.created_with = TogglClient.USER_AGENT;
    ...
    this._apiRequest('/api/v8/time_entries/start', req, utils.wrapDataCallback(callback));
};
 ...
 * @param {function} callback Accepts arguments: (err, timeEntry)
 */
proto.stopTimeEntry = function (teId, callback) {
    var req = {
        method: 'PUT'
    };

    this._apiRequest('/api/v8/time_entries/' + teId + '/stop', req, utils.wrapDataCallback(callback));
};
 ...
 * @param {function} callback Accepts arguments: (err, timeEntry)
 */
proto.updateTimeEntry = function (teId, data, callback) {
    var req = {
        method: 'PUT',
        body: {
            time_entry: data
    ...
    this._apiRequest('/api/v8/time_entries/' + teId, req, utils.wrapDataCallback(callback));
};
 ...
 * @param {function} callback Accepts arguments: (err, timeEntries)
 */
proto.updateTimeEntriesTags = function (teIds, tags, action, callback) {
    var body = {
        tag_action: action,
        tags: tags
    };

    if (!this._validateOptions('time-entry-update-tags', body, callback)) {
        return;
    }
    ...
    this._apiRequest('/api/v8/time_entries/' + teIds.join(','), req, utils.wrapDataCallback(callback));
};
