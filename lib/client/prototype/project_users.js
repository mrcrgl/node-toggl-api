 ...
 */
proto.addProjectUser = function(projectId, userId, options, fields, callback) {
  ...
  if (!this._validateOptions('project-user-add', options, callback)) {
    return;
  }
  ...
  this._apiRequest('/api/v8/project_users', req, utils.wrapDataCallback(callback));
};
 ...
 */
proto.addProjectUsers = function(projectId, userIds, options, fields, callback) {
 ...
 */
proto.deleteProjectUser = function(puID, callback) {
  var req = {
    method: 'DELETE'
  };

  this._apiRequest('/api/v8/project_users/' + puID, req, callback);
};
 ...
 * @param {function} callback Accepts arguments: (err)
 */
proto.deleteProjectUsers = function(puIDs, callback) {
 ...
 * @param {function} callback Accepts arguments: (err, projectUser)
 */
proto.updateProjectUser = function(puID, options, fields, callback) {
  if (arguments.length === 3) {
    callback = fields;
    fields = null;
  }
  ...
  this._apiRequest('/api/v8/project_users/' + puID, req, utils.wrapDataCallback(callback));
};
 ...
 * @param {function} callback Accepts arguments: (err, projectUsers)
 */
proto.updateProjectUsers = function(puIDs, options, fields, callback) {
  var args = utils.args(arguments);
  args[0] = puIDs.join();
  callback = args.pop();
  args.push(utils.wrapDataCallback(callback));
